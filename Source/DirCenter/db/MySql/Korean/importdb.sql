...
create database `snscenter` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
DROP database IF EXISTS `paydb`;
create database `paydb` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;

select 'create databases:snscenter,paydb successfull!';

/*grant user*/
Delete FROM mysql.user Where User='game_user';
grant select,insert,update,delete,create,alter,drop on *.* to game_user@'%' Identified by 'qweasd!';
