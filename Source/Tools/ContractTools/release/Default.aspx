        ...
        <div class="layout">
            ...
            <div class="left">
                <div class="toolbar">
                    ...
                    <span>필터:</span><input type="text" id="txtSearch" name="txtSearch" style="width: 120px" onkeypress="EnterPress(event)" onkeydown="EnterPress()"/>
                ...
                <div class="content">
                    <table style="width: 100%; background: #f0f0f0; padding: 5px;" cellspacing="4">
                        <tr>
                            <td style="width: 25%; text-align: right;"><span class="space">파라메터타입:</span></td>
                            <td>
                                ...
                                </asp:DropDownList><span>（Record：순환체시작표식，End：종료표식，Void：폐기，Password：암호화표식）</span>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr><td style="text-align: right">
                            ...
                            <td style="padding-top: 5px;">
                                <asp:Button ID="btnParamAdd" runat="server" Text="새파라메터추가" OnClick="btnParamAdd_Click" CssClass="btn" />
                                <span style="padding:0 5px"></span>
                                <asp:Button ID="btnParamCopy" runat="server" Text="파라메터복사" OnClick="btnParamCopy_Click" CssClass="btn" AutoPostBack="True" />
                                <span style="padding:0 5px"></span>
                                <asp:Button ID="btnParamRemove" runat="server" Text="파라메터삭제" OnClick="btnParamRemove_Click" CssClass="btn"/>
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align: right">
                                <span>위치에서파라메터복사:</span>
                            </td>
                            <td style="padding-top: 5px;">
