    ...
    <div class="main">
        <div class="content">
            <table style="width: 100%; text-align: center; background: #f0f0f0;padding: 15px 5px;" >
                <tr>
                    <td style="width: 40%;text-align: right">클래스명</td>
                ...
                <tr>
                    <td style="text-align: right;">묘사</td>
                    <td style="text-align: left;">
                    ...
                    <td colspan="2" style="padding-top: 15px;">
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"  Width="100%" CssClass="grid" 
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="클래스명" ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Center">
                                    <EditItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="묘사" ItemStyle-Width="30%" ItemStyle-HorizontalAlign="Center">
                                    <EditItemTemplate>
                                ...
                                <asp:CommandField HeaderText="작업(컨트롤)" ItemStyle-HorizontalAlign="Center" ShowDeleteButton="True"
                                    ShowEditButton="True">
                                    <ItemStyle Width="10%" />
                                </asp:CommandField>
                            </Columns>
